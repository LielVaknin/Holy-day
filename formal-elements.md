...
* האינטראקציה במשחק הוא בין השחקן למערכת כאשר במהלך המשחק השחקן מבצע פעולות שונות על מנת לעבור לשלב הבא במשחק,כאשר המערכת מחזירה משוב לגבי כל משימה בה נכשל או הצליח 
